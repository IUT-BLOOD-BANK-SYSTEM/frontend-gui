        ...
        <div className="flex flex-col w-1/2 gap-5">
          ...
          <div className="flex justify-center mt-5 text-center">
            <button
              ...
              onClick={handleClick}
              disabled={!role}
              className={`bg-secondary w-full text-white py-2 px-4 rounded-md hover:bg-[#B01733] transition-colors duration-300 ${
                role ? "cursor-pointer" : "cursor-not-allowed"
              } ${role ? "opacity-100" : "opacity-60"}`}
            >
              Continue
            </button>
          </div>
