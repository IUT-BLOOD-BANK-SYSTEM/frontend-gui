  ...
  return (
    ...
    <div className="w-1/2">
      ...
      <form className="space-y-5">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Bloodtypes</label>
          <select
            className="w-full p-2 border border-[#e0e0e0] rounded bg-primary text-white focus:outline-none focus:ring focus:ring-[#e0e0e0]"
            required
          >
            <option value="">Select an option</option>
            <option value="Blood_Type(O-)">O-</option>
            <option value="Blood_Type(O+)">O+</option>
            <option value="Blood_Type(A+)">A+</option>
            <option value="Blood_Type(A-)">A-</option>
            <option value="Blood_Type(B+)">B+</option>
            <option value="Blood_Type(B-)">B-</option>
            <option value="Blood_Type(AB+)">AB+</option>
            <option value="Blood_Type(AB-)">AB-</option>
          </select>
